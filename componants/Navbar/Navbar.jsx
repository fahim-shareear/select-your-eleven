...
const Navbar = ({availBalance}) => {
    const handleClick = () =>{
        toast("Free credit isn't available now. Come Back Later!");
    }
    return (
        <>
            ...
            <div className='banner max-w-[1200px] mx-auto  bg-black rounded-2xl mt-10'>
                ...
                <div className="banner_content">
                    ...
                    <div className='w-[240px] flex items-center justify-center h-[70px] border-2 border-yellow-500 mt-8 rounded-2xl'>
                        <button className='btn text-2xl text-black font-bold p-2 cursor-pointer bg-yellow-500 rounded-2xl' 
